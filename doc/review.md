...
### I. Publish / legs / attachments
Проверь:
- `scheduled` действительно требует planned datetime;
- leg validation не позволяет чужие или несуществующие инструменты;
...
- preview and subscriber-facing rendering for recommendations
- moderation queue
...
- не протекает ли attachment metadata или object key в несогласованный storage path;
