...
5. Telegram UX depth:
   - richer in-app reminder center and notification preferences
   - deeper WebApp auth bridge
   - renewal/re-subscribe timeline beyond current baseline
5. Telegram UX depth:
   - richer payment result messaging after refresh/retry
   - deeper WebApp auth bridge
   - renewal/re-subscribe history and reminders inside Mini App
